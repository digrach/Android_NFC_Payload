...
public class WritePayLoadActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_write_pay_load);
...
//            new Intent(this, getClass()).addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP), 0);
		PendingIntent pendingIntent = PendingIntent.getActivity(this, 0,
	            new Intent(this, getClass()).addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY), 0);
	...
	private boolean writeTag(Tag tag) {
		...
		// is name of app package
//		NdefRecord appRecord = NdefRecord.createApplicationRecord("com.example.nfcpayload");
		NdefRecord appRecord = NdefRecord.createApplicationRecord("playcabbage.chisholm.app.Cabbage");
		
		// record that contains our custom "superid" game data, using custom MIME_TYPE
		byte[] payload = getSuperID().getBytes(); // This is the message/payload
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_write_pay_load, menu);
		return true;
	}
